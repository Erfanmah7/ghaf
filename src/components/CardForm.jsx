...
function CardForm() {
  ...
  const { data, mutate, isPending, isLoading } = postMutation();
  ...
  return (
    <>
      ...
      <form onSubmit={addHandler} className="relative drop-shadow-md">
        ...
        <div className="flex flex-col justify-start pb-9 md:px-11 px-5 pt-9 bg-white rounded-2xl rounded-bl-none">
          {/* form */}
          <div className="grid md:grid-cols-3 grid-cols-1 gap-3 dark:text-white">
            ...
            <div className="flex flex-col space-y-1">
              ...
              >
                ...
                <option value="Indirect">
                  رابطه غیر مستقیم: به طور مثال نمایشی از قدمت و سنت ملی آن
                  کشور؛ مانند جام بانک پاسارگاد
                </option>
            ...
            <div className="flex flex-col space-y-1">
              <label
                ...
                htmlFor="logoconcept"
              >
                معنای لغوی و ارتباط آن با فعالیت مجموعه خود را ذکر نمایید:
                <span className="text-black">
                  <svg className="h-[10px] w-[10px] dark:text-white text-black ">
                    <use href="#star"></use>
                  </svg>
              ...
              <input
                placeholder="قوی‌ترین، باتجربه‌ترین و فعال‌ترین..."
                className="py-2 px-2 w-full border-zinc-200 border dark:border-zinc-500 bg-zinc-200/15 rounded-md focus:outline-none"
                type="text"
                name="logoconcept"
                id="logoconcept"
            ...
            <div className="flex flex-col space-y-1">
              <label
                ...
                htmlFor="feel"
              >
                در لوگو چه اطلاعات؛ پیام و احساسی به مخاطب منتقل شود؟
                <span className="text-black">
                  <svg className="h-[10px] w-[10px] dark:text-white text-black ">
                    <use href="#star"></use>
                  </svg>
              ...
              <input
                placeholder="استحکام و قوی بودن"
                className="py-2 px-2 w-full border-zinc-200 border dark:border-zinc-500 bg-zinc-200/15 rounded-md focus:outline-none"
                type="text"
                name="feel"
                id="feel"
        ...
        <svg className="h-[50px] w-[50px] absolute top-[235px] -right-7 md:inline-block hidden  text-black text-gradient-to-t from-zinc-700 ">
          <use href="#star"></use>
        </svg>
        <svg className="h-[50px] w-[50px] absolute top-[50px] -left-6 md:inline-block hidden text-black text-gradient-to-t from-zinc-700 ">
          <use href="#star"></use>
        </svg>
        <button
          type="submit"
